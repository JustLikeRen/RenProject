...
//	static private String DB_JDBC_DRIVER_PACKAGE_PATH = "oracle.jdbc.OracleDriver";	//오라클
	...
	static private String DB_LOGIN_NAME = "my_cat";
	static private String DB_URL_MYSQL = "jdbc:mysql://localhost:3306/"+DB_NAME;	//mysql
	static private String DB_URL_LOGIN_MYSQL = "jdbc:mysql://localhost:3306/"+DB_LOGIN_NAME;	//mysql
//	static private String DB_URL_ORACLE = "jdbc:oracle:thin:@127.0.0.1:1521:"+DB_NAME;	//오라클
	...
	static public String DB_LOGINURL = DB_URL_LOGIN_MYSQL;
	/* table들 */
	////	게시판
	public static final String TABLE_PS_BOARD_FREE = "member_list";	//자유게시판
