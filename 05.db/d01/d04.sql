...
update tottenham_squad set p_name = '로드리고밴탕쿠르' where p_number = 30;
...
-- select * from tottenham_squad order by p_number asc; #1부터 오름차순
-- select * from tottenham_squad order by p_number; desc# 내림차순

update tottenham_squad set weekly_pay = 259060 where p_name = '손흥민';
update tottenham_squad set weekly_pay = 152388 where p_name = '히살리송';
update tottenham_squad set weekly_pay = 228582 where p_name = '이반 페리시치';
update tottenham_squad set weekly_pay = 213343 where p_name = '제임스 메디슨';
update tottenham_squad set weekly_pay = 207095 where p_name = '크리스티안 로메로';
